...
/**
 Base class for all TiPhotoNote views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiPhotoNote view hierarchy (such as wrapped iOS UIViews) was touched.
