...
@interface TiPhotoNoteObject : KrollCoverageObject {
#else
@interface TiPhotoNoteObject : KrollObject {
#endif
@private
...
extern NSString * TiPhotoNote$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiPhotoNoteObject *_tiphotonote;
    KrollObject* console;
	BOOL shutdown;
