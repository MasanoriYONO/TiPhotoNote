 ...
 * Copyright (c) 2009-2011 by TiPhotoNote, Inc. All Rights Reserved.
...
//@interface TiPhotoNoteObject : NSObject
//@end

@interface TiPhotoNoteObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiPhotoNoteObject class]])
		{
			for (NSString *key in [[(TiPhotoNoteObject*)o modules] allKeys])
			{
