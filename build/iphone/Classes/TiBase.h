...
// in simulator we redefine to format for TiPhotoNote Developer console
...
{\
	NSString * exceptionName = [@"org.tiphotonote." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiphotonote";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiPhotoNoteNativeItemNone = -1, 
	UITiPhotoNoteNativeItemSpinner = -2,
	UITiPhotoNoteNativeItemProgressBar = -3,
	
	UITiPhotoNoteNativeItemSlider = -4,
	UITiPhotoNoteNativeItemSwitch = -5,
	UITiPhotoNoteNativeItemMultiButton = -6,
	UITiPhotoNoteNativeItemSegmented = -7,
	
	UITiPhotoNoteNativeItemTextView = -8,
	UITiPhotoNoteNativeItemTextField = -9,
	UITiPhotoNoteNativeItemSearchBar = -10,
	
	UITiPhotoNoteNativeItemPicker = -11,
	UITiPhotoNoteNativeItemDatePicker = -12,
	
	UITiPhotoNoteNativeItemInfoLight = -13,
	UITiPhotoNoteNativeItemInfoDark = -14,
	
	UITiPhotoNoteNativeItemDisclosure = -15,
	
	UITiPhotoNoteNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiPhotoNote instances of
